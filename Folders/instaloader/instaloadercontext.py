...
class InstaloaderContext:
    ...
    def login(self, user, passwd):
        ...
        #enc_password='%23PWD_INSTAGRAM_BROWSER%3A10%3A1688385848%3AAY5QABudnakyuHs4PHMbSH09UoIS6ZRxGcTOlNzIzzkagQxpsx7NUCznzk0%2Bwc1m4Zw%2FXEqcSmBfDEXX2M8growj%2B2geQD1M3xTNIRXZxuRPPY4KhjL9L7MsJfqaUbFLEM5r%2BSh8OaszVfmB&'.format(int(datetime.now().timestamp()), passwd)
